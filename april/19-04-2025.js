...
// console.log(tupleVar.length); //Object

// let nameTuple : [firstName:string, secondName : string] = ['john','doe']

// console.log(nameTuple.fi)
...
// let firstValue : any = 'jrls';

// console.log(firstValue.toUpperCase());

// console.log(firstValue);

// let secondValue :any  = 'something!';

// //cannot give property
// console.log(secondValue.toUpperCase());

// console.log(typeof secondValue);

// //cannnot asssign to any given type to this value in unknow but we can assing in any!
