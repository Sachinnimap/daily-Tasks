import { Controller, Delete, Get, Post, Put, Req, Res,HttpStatus,HttpCode } from "@nestjs/common";
...
export class LibraryController {
  ...
  //get list of books
  @Get('/')
  @HttpCode(201) //in response we automatically send this Status!
  // @HttpCode(HttpStatus.OK) //we can also share Status like this like this
  getBooks(@Req() req:Request,@Res() res:Response) { //we dont need every time to write res we directly return!
